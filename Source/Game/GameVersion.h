...
public:
	...
	void setGroupFileInstallPath(const std::string & groupFileInstallPath);
	void clearGroupFileInstallPath();
	bool hasAlternateModFilesInstallPath() const;
	const std::optional<std::string> & getUnevaluatedAlternateModFilesInstallPath() const;
	std::optional<std::string> getEvaluatedAlternateModFilesInstallPath() const;
	void setAlternateModFilesInstallPath(const std::string & alternateModFilesInstallPath);
	void clearAlternateModFilesInstallPath();
	bool hasGroupFileMaximum() const;
	const std::optional<uint16_t> & getMaximumGroupFiles() const;
	bool doesGroupCountExceedMaximumGroupFilesLimit(uint16_t groupCount) const;
	void setMaximumGroupFiles(uint16_t maximumGroupFiles);
	void clearMaximumGroupFiles();
	bool doesRequireOriginalGameFiles() const;
	const std::optional<bool> & getRequiresOriginalGameFiles() const;
	void setRequiresOriginalGameFiles(bool requiresOriginalGameFiles);
	void clearRequiresOriginalGameFiles();
	...
	bool hasEpisodeArgumentFlag() const;
	const std::optional<std::string> & getEpisodeArgumentFlag() const;
	bool setEpisodeArgumentFlag(const std::string & flag);
	void clearEpisodeArgumentFlag();
	bool hasLevelArgumentFlag() const;
	const std::optional<std::string> & getLevelArgumentFlag() const;
	bool setLevelArgumentFlag(const std::string & flag);
	void clearLevelArgumentFlag();
	bool hasSkillArgumentFlag() const;
	const std::optional<std::string> & getSkillArgumentFlag() const;
	bool setSkillArgumentFlag(const std::string & flag);
	void clearSkillArgumentFlag();
	bool hasSkillStartValue() const;
	...
	static const std::string ALL_VERSIONS_SHORT_NAME;
	static const std::string ALL_VERSIONS_LONG_NAME;
...
private:
	...
	std::optional<std::string> m_gameExecutableDirectoryPath;
	std::optional<std::string> m_setupExecutableName;
	std::string m_gameConfigurationFileName;
	std::optional<std::string> m_gameConfigurationDirectoryPath;
	std::string m_launchArguments;
	std::optional<std::string> m_groupFileInstallPath;
	std::optional<std::string> m_alternateModFilesInstallPath;
	std::optional<uint16_t> m_maximumGroupFiles;
	std::optional<bool> m_requiresOriginalGameFiles;
	...
	std::optional<std::string> m_episodeArgumentFlag;
