...
static constexpr const char * JSON_GAME_EXECUTABLE_DIRECTORY_PATH_PROPERTY_NAME = "gameExecutableDirectoryPath";
static constexpr const char * JSON_SETUP_EXECUTABLE_NAME_PROPERTY_NAME = "setupExecutableName";
static constexpr const char * JSON_GAME_CONFIGURATION_FILE_NAME_PROPERTY_NAME = "gameConfigurationFileName";
static constexpr const char * JSON_GAME_CONFIGURATION_DIRECTORY_PATH_PROPERTY_NAME = "gameConfigurationDirectoryPath";
...
static constexpr const char * JSON_ALTERNATE_MOD_FILES_INSTALL_PATH_PROPERTY_NAME = "alternateModFilesInstallPath";
static constexpr const char * JSON_SCRIPT_FILES_READ_FROM_GROUP_PROPERTY_NAME = "scriptFilesReadFromGroup";
...
static constexpr const char * JSON_SUPPORTS_ZIP_ARCHIVE_GROUPS_PROPERTY_NAME = "zipArchiveGroupsSupported";
...
static constexpr const char * JSON_CONFLICTING_GAME_FILES_PROPERTY_NAME = "conflictingGameFiles";
static constexpr const char * JSON_NOTES_PROPERTY_NAME = "notes";
static const std::array<std::string_view, 49> JSON_PROPERTY_NAMES = {
	...
	JSON_GAME_EXECUTABLE_DIRECTORY_PATH_PROPERTY_NAME,
	JSON_SETUP_EXECUTABLE_NAME_PROPERTY_NAME,
	JSON_GAME_CONFIGURATION_FILE_NAME_PROPERTY_NAME,
	JSON_GAME_CONFIGURATION_DIRECTORY_PATH_PROPERTY_NAME,
	JSON_LAUNCH_ARGUMENTS_PROPERTY_NAME,
	JSON_GROUP_FILE_INSTALL_PATH_PROPERTY_NAME,
	JSON_ALTERNATE_MOD_FILES_INSTALL_PATH_PROPERTY_NAME,
	JSON_SCRIPT_FILES_READ_FROM_GROUP_PROPERTY_NAME,
	JSON_SUPPORTS_SUBDIRECTORIES_PROPERTY_NAME,
	JSON_SUPPORTS_WORLD_TOUR_GROUP_PROPERTY_NAME,
	JSON_SUPPORTS_ZIP_ARCHIVE_GROUPS_PROPERTY_NAME,
	...
	JSON_CONFLICTING_GAME_FILES_PROPERTY_NAME,
	JSON_NOTES_PROPERTY_NAME
};

static const std::string GAME_CFG_VARIABLE_NAME("GAMECFG");
...
const GameVersion GameVersion::LAMEDUKE                ("lameduke",    "Duke Nukem 3D Beta 1.3.95 (LameDuke)",        "LameDuke",                 true,  false, "", "D3D.EXE",            {},       "SETUP.DAT",                          {},                                   true,  {},    false, {},    {},    0,  "LameDuke",  {},    {},     {},    {},      "/v", "/l", "/s", 0,  "/r", {},    {},   {},   {},   {},    {},    "SETUP.EXE", {}, {},                             {},    {},     {},    true, "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { },                                                                                                                                      { },                                              { },                                                                                                                                                                                                                                                                            { DOSBoxConfiguration({ DOSBoxConfiguration::Section("cpu", { DOSBoxConfiguration::Section::Entry("cycles", "50000") }) }) });
const GameVersion GameVersion::ORIGINAL_BETA_VERSION   ("beta",        "Duke Nukem 3D Beta 0.99",                     "Duke 3D Beta 0.99",        true,  true,  "", "DUKE3D.EXE",         {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    false, {},    {},    0,  "Beta",      {},    {},     {},    {},      "/v", "/l", "/s", 0,  "/r", {},    "/t", {},   "/m", {},    {},    "SETUP.EXE", "", {},                             {},    {},     {},    true, "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { REGULAR_ID },                                                                                                                           { },                                              { "Has extremely poor support for mods.", "Does not function properly out of the box." });
const GameVersion GameVersion::ORIGINAL_REGULAR_VERSION(REGULAR_ID,    "Duke Nukem 3D 1.3D",                          "Duke 3D 1.3D",             true,  false, "", "DUKE3D.EXE",         {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    true,  {},    {},    1,  "Regular",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", {},    "/t", "/u", "/m", "/ns", "/nm", "SETUP.EXE", "", {},                             {},    {},     true,  {},   "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { ORIGINAL_BETA_VERSION.getID() });
const GameVersion GameVersion::ORIGINAL_PLUTONIUM_PAK  ("plutonium",   "Duke Nukem 3D: Plutonium Pak 1.4",            "Plutonium Pak",            true,  true,  "", "DUKE3D.EXE",         {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    true,  false, {},    4,  "PlutPak",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", "SETUP.EXE", "", {},                             {},    {},     {},    {},   "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { ATOMIC_ID },                                                                                                                            { },                                              { "Virtually identical to Duke Nukem 3D Atomic Edition." });
const GameVersion GameVersion::ORIGINAL_ATOMIC_EDITION (ATOMIC_ID,     "Duke Nukem 3D: Atomic Edition 1.5",           "Atomic Edition",           true,  false, "", "DUKE3D.EXE",         {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    true,  true,  {},    4,  "Atomic",    "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", "SETUP.EXE", "", {},                             {},    {},     {},    {},   "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { ORIGINAL_PLUTONIUM_PAK.getID() });
const GameVersion GameVersion::JFDUKE3D                ("jfduke3d",    "JFDuke3D",                                    "JFDuke3D",                 true,  false, "", "duke3d.exe",         {},       GameConfiguration::DEFAULT_FILE_NAME, "<APPDATA>/<GAMEID>",                 true,  {},    true,  true,  {},    4,  "JFDuke3D",  "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},                             {},    {},     {},    {},   "http://www.jonof.id.au/jfduke3d",                               "https://github.com/jonof/jfduke3d",                                        { OperatingSystem::Windows, OperatingSystem::MacOS },                         { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::MEGATON_EDITION         ("megaton",     "Duke Nukem 3D: Megaton Edition",              "Megaton Edition",          false, true,  "", "duke3d.exe",         "../bin", GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    true,  true,  {},    4,  "Megaton",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          {}, {},                             {},    {},     {},    {},   "https://store.steampowered.com/app/225140",                     "https://github.com/TermiT/duke3d-megaton",                                 { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() },                  { "duke3d-megaton.def", "duke3d-megaton_3.def" }, { "Requires de-listed Steam retail copy to be installed.", "Fails to use correct episode names, if overridden." });
const GameVersion GameVersion::DUKE3DW                 ("duke3dw",     "Duke3dw",                                     "Duke3dw",                  true,  true,  "", "Duke3dw.exe",        {},       "Duke3dw.cfg",                        {},                                   true,  {},    true,  true,  {},    8,  "Duke3dw",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},                             "/h",  {},     {},    {},   "http://www.proasm.com/duke/Duke3dw.html",                       "",                                                                         { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() });
const GameVersion GameVersion::EDUKE32                 ("eduke32",     "eDuke32",                                     "eDuke32",                  true,  false, "", "eduke32.exe",        {},       "eduke32.cfg",                        {},                                   false, true,  true,  true,  true,  8,  "eDuke32",   "-x ", "-mx ", "-g ", "-map ", "-v", "-l", "-s", 1,  "-r", "-d ", "-t", "-u", "-m", "-ns", "-nm", {},          "", {},                             "-h ", "-mh ", {},    {},   "https://www.eduke32.com",                                       "https://voidpoint.io/terminx/eduke32",                                     { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() });
const GameVersion GameVersion::NETDUKE32               ("netduke32",   "NetDuke32",                                   "NetDuke32",                true,  true,  "", "netduke32.exe",      {},       "netduke32.cfg",                      {},                                   false, true,  true,  true,  true,  8,  "NetDuke",   "-x ", "-mx ", "-g ", "-map ", "-v", "-l", "-s", 1,  "-r", "-d ", "-t", "-u", "-m", "-ns", "-nm", {},          "", {},                             "-h ", "-mh ", {},    {},   "https://wiki.eduke32.com/wiki/NetDuke32",                       "https://voidpoint.io/StrikerTheHedgefox/eduke32-csrefactor/-/tree/master", { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID(), EDUKE32.getID() });
const GameVersion GameVersion::RED_NUKEM               ("rednukem",    "RedNukem",                                    "RedNukem",                 true,  true,  "", "rednukem.exe",       {},       "rednukem.cfg",                       {},                                   false, true,  true,  true,  {},    8,  "RedNukem",  "-x ", "-mx ", "-g ", "-map ", "-v", "-l", "-s", 1,  "-r", "-d ", "-t", "-u", "-m", "-ns", "-nm", {},          "", {},                             "-h ", "-mh ", {},    {},   "https://lerppu.net/wannabethesis",                              "https://github.com/nukeykt/NRedneck",                                      { OperatingSystem::Windows },                                                 { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(),  JFDUKE3D.getID() });
const GameVersion GameVersion::DUKE3D_W32              ("duke3d_w32",  "Duke3d_w32",                                  "Duke3d_w32",               true,  true,  "", "duke3d_w32.exe",     {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    false, true,  {},    4,  "Duke_w32",  "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},                             {},    {},     {},    {},   "http://www.rancidmeat.com/project.php3?id=1",                   "",                                                                         { OperatingSystem::Windows },                                                 { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::XDUKE                   ("xduke",       "xDuke",                                       "xDuke",                    true,  true,  "", "duke3d_w32.exe",     {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    false, false, {},    4,  "xDuke",     "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},                             {},    {},     {},    {},   "http://vision.gel.ulaval.ca/~klein/duke3d",                     "",                                                                         { OperatingSystem::Windows },                                                 { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::RDUKE                   ("rduke",       "rDuke",                                       "rDuke",                    true,  true,  "", "rduke_r10.exe",      {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    false, false, {},    4,  "rDuke",     "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},                             {},    {},     {},    {},   "",                                                              "https://github.com/radar-duker/radars-xduke-fork",                         { OperatingSystem::Windows },                                                 { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
//const GameVersion GameVersion::CHOCOLATE_DUKE3D        ("chocolate",   "Chocolate Duke Nukem 3D",                     "Chocolate Duke3D",         true,  true,  "", "Game.exe",           {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    false, true,  {},    4,  "Chocolate", "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          {}, {},                             {},    {},     {},    {},   "https://fabiensanglard.net/duke3d/chocolate_duke_nukem_3D.php", "https://github.com/fabiensanglard/chocolate_duke3D",                       { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::BELGIAN_CHOCOLATE_DUKE3D("belgian",     "Belgian Chocolate Duke Nukem 3D",             "Belgian Chocolate Duke3D", true,  true,  "", "ChocoDuke3D.64.exe", {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    false, false, {},    4,  "Belgian",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},                             {},    {},     {},    {},   "",                                                              "https://github.com/GPSnoopy/BelgianChocolateDuke3D",                       { OperatingSystem::Windows, OperatingSystem::Linux, OperatingSystem::MacOS }, { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::RAZE                    ("raze",        "Raze",                                        "Raze",                     true,  true,  "", "raze.exe",           {},       "raze.ini",                           "<HOME>/Documents/My Games/<GAMEID>", true,  true,  true,  true,  {},    {}, "Raze",      "-x ", {},     "-g ", "-map ", "-v", "-l", "-s", 1,  "-r", "-d ", "-t", "-u", "-m", "-ns", "-nm", {},          "", {},                             {},    {},     {},    {},   "https://raze.zdoom.org/about",                                  "https://github.com/coelckers/Raze",                                        { OperatingSystem::Windows, OperatingSystem::Linux, OperatingSystem::MacOS }, { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(),  JFDUKE3D.getID() });
const GameVersion GameVersion::PKDUKE3D                ("pkduke3d",    "pkDuke3D",                                    "pkDuke3D",                 true,  true,  "", "pkDuke3d.exe",       {},       GameConfiguration::DEFAULT_FILE_NAME, {},                                   true,  {},    true,  true,  {},    4,  "pkDuke3D",  "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1,  "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},                             {},    {},     {},    {},   "https://bitbucket.org/pogokeen/pkduke3d/downloads",             "https://bitbucket.org/pogokeen/pkduke3d",                                  { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() },                  { },                                              { "Has some issues running mods, such as missing episode names." });
const GameVersion GameVersion::BUILDGDX                ("buildgdx",    "BuildGDX",                                    "BuildGDX",                 true,  true,  "", "BuildGDX.exe",       {},       "dukegdx.ini",                        "<HOME>/M210Projects/DukeGDX",        true,  {},    true,  true,  true,  1,  "BuildGDX",  {},    {},     {},    {},      {},   {},   {},   {}, {},   {},    {},   {},   {},   {},    {},    {},          {}, "<GAMECFG:Main:Path>/autoload", {},    {},     {},    {},   "https://m210.duke4.net/index.php/downloads/category/8-java",    "https://gitlab.com/m210/BuildGDX",                                         { OperatingSystem::Windows, OperatingSystem::Linux, OperatingSystem::MacOS }, { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() },                  { },                                              { "Does not automatically load into DukeGDX with mod enabled.", "Mod files must be selected manually from custom content autoload directory.", "Version 1.18 has known issues with audio playback.", "Other mod files in autoload directory can conflict with selected mod." });
...
const uint16_t GameVersion::DEFAULT_MAXIMUM_GROUP_FILES = 4;

GameVersion::GameVersion()
	: m_standAlone(false)
	, m_installable(false)
	, m_removable(true)
	, m_maximumGroupFiles(DEFAULT_MAXIMUM_GROUP_FILES)
...
GameVersion::GameVersion(const std::string & id, const std::string & longName, const std::string & shortName, bool installable, bool removable, const std::string & gamePath, const std::string & gameExecutableName, const std::optional<std::string> & gameExecutableDirectoryPath, const std::string & gameConfigurationFileName, const std::optional<std::string> & gameConfigurationDirectoryPath, bool localWorkingDirectory, std::optional<bool> scriptFilesReadFromGroup, bool supportsSubdirectories, std::optional<bool> worldTourGroupSupported, std::optional<bool> zipArchiveGroupsSupported, std::optional<uint16_t> maximumGroupFiles, const std::string & modDirectoryName, const std::optional<std::string> & conFileArgumentFlag, const std::optional<std::string> & extraConFileArgumentFlag, const std::optional<std::string> & groupFileArgumentFlag, const std::optional<std::string> & mapFileArgumentFlag, const std::optional<std::string> & episodeArgumentFlag, const std::optional<std::string> & levelArgumentFlag, const std::optional<std::string> & skillArgumentFlag, std::optional<uint8_t> skillStartValue, const std::optional<std::string> & recordDemoArgumentFlag, const std::optional<std::string> & playDemoArgumentFlag, const std::optional<std::string> & respawnModeArgumentFlag, const std::optional<std::string> & weaponSwitchOrderArgumentFlag, const std::optional<std::string> & disableMonstersArgumentFlag, const std::optional<std::string> & disableSoundArgumentFlag, const std::optional<std::string> & disableMusicArgumentFlag, const std::optional<std::string> & setupExecutableName, const std::optional<std::string> & groupFileInstallPath, const std::optional<std::string> & alternateModFilesInstallPath, const std::optional<std::string> & defFileArgumentFlag, const std::optional<std::string> & extraDefFileArgumentFlag,const std::optional<bool> & requiresOriginalGameFiles, const std::optional<bool> & requiresGroupFileExtraction, const std::string & website, const std::string & sourceCodeURL, const std::vector<OperatingSystem> & supportedOperatingSystems, const std::vector<std::string> & compatibleGameVersionIdentifiers, const std::vector<std::string> & conflictingGameFiles, const std::vector<std::string> & notes, const DOSBoxConfiguration & dosboxConfiguration)
	...
	, m_gameExecutableDirectoryPath(gameExecutableDirectoryPath.has_value() ? Utilities::trimString(gameExecutableDirectoryPath.value()) : std::optional<std::string>())
	, m_setupExecutableName(setupExecutableName.has_value() ? Utilities::trimString(setupExecutableName.value()) : std::optional<std::string>())
	, m_gameConfigurationFileName(Utilities::trimString(gameConfigurationFileName))
	, m_gameConfigurationDirectoryPath(gameConfigurationDirectoryPath.has_value() ? Utilities::trimString(gameConfigurationDirectoryPath.value()) : std::optional<std::string>())
	, m_groupFileInstallPath(groupFileInstallPath.has_value() ? Utilities::trimString(groupFileInstallPath.value()) : std::optional<std::string>())
	, m_alternateModFilesInstallPath(alternateModFilesInstallPath.has_value() ? Utilities::trimString(alternateModFilesInstallPath.value()) : std::optional<std::string>())
	...
	, m_scriptFilesReadFromGroup(scriptFilesReadFromGroup)
	, m_supportsSubdirectories(supportsSubdirectories)
	, m_worldTourGroupSupported(worldTourGroupSupported)
	, m_zipArchiveGroupsSupported(zipArchiveGroupsSupported)
	...
	, m_conflictingGameFiles(conflictingGameFiles)
	, m_notes(notes)
...
GameVersion::GameVersion(GameVersion && gameVersion) noexcept
	...
	, m_gameExecutableDirectoryPath(std::move(gameVersion.m_gameExecutableDirectoryPath))
	, m_setupExecutableName(std::move(gameVersion.m_setupExecutableName))
	, m_gameConfigurationFileName(std::move(gameVersion.m_gameConfigurationFileName))
	, m_gameConfigurationDirectoryPath(std::move(gameVersion.m_gameConfigurationDirectoryPath))
	...
	, m_alternateModFilesInstallPath(std::move(gameVersion.m_alternateModFilesInstallPath))
	...
	, m_zipArchiveGroupsSupported(gameVersion.m_zipArchiveGroupsSupported)
	...
	, m_skillStartValue(std::move(gameVersion.m_skillStartValue))
	...
	, m_conflictingGameFiles(std::move(gameVersion.m_conflictingGameFiles))
...
GameVersion::GameVersion(const GameVersion & gameVersion)
	...
	, m_gameExecutableDirectoryPath(gameVersion.m_gameExecutableDirectoryPath)
	, m_setupExecutableName(gameVersion.m_setupExecutableName)
	, m_gameConfigurationFileName(gameVersion.m_gameConfigurationFileName)
	, m_gameConfigurationDirectoryPath(gameVersion.m_gameConfigurationDirectoryPath)
	, m_launchArguments(gameVersion.m_launchArguments)
	, m_groupFileInstallPath(gameVersion.m_groupFileInstallPath)
	, m_alternateModFilesInstallPath(gameVersion.m_alternateModFilesInstallPath)
	, m_maximumGroupFiles(gameVersion.m_maximumGroupFiles)
	, m_requiresOriginalGameFiles(gameVersion.m_requiresOriginalGameFiles)
	, m_requiresGroupFileExtraction(gameVersion.m_requiresGroupFileExtraction)
	, m_localWorkingDirectory(gameVersion.m_localWorkingDirectory)
	...
	, m_conflictingGameFiles(gameVersion.m_conflictingGameFiles)
...
bool GameVersion::isInstallable() const {
...
const std::string & GameVersion::getUnevaluatedGamePath() const {
	return m_gamePath;
}

std::optional<std::string> GameVersion::getEvaluatedGamePath() const {
	if(std::regex_match(m_gamePath, GAME_CFG_VARIABLE_REGEX)) {
		spdlog::error("Cannot use '{}' variable name inside of game path.", GAME_CFG_VARIABLE_NAME);
		return {};
	}

	return evaluateFilePath(m_gamePath);
}
...
std::optional<std::string> GameVersion::getEvaluatedGameExecutableFilePath() const {
	if(!m_gameExecutableDirectoryPath.has_value() || m_gameExecutableDirectoryPath->empty()) {
		return m_gameExecutableName;
	}

	std::optional<std::string> optionalEvaluatedGameExecutableDirectoryPath(evaluateFilePath(m_gameExecutableDirectoryPath.value()));

	if(!optionalEvaluatedGameExecutableDirectoryPath.has_value()) {
		return {};
	}

	return Utilities::joinPaths(optionalEvaluatedGameExecutableDirectoryPath.value(), m_gameExecutableName);
}
...
bool GameVersion::hasGameExecutableDirectoryPath() const {
	return m_gameExecutableDirectoryPath.has_value();
}

const std::optional<std::string> & GameVersion::getUnevaluatedGameExecutableDirectoryPath() const {
	return m_gameExecutableDirectoryPath;
}

std::optional<std::string> GameVersion::getEvaluatedGameExecutableDirectoryPath() const {
	if(!m_gameExecutableDirectoryPath.has_value()) {
		return {};
	}

	return evaluateFilePath(m_gameExecutableDirectoryPath.value());
}

void GameVersion::setGameExecutableDirectoryPath(const std::string & directoryPath) {
	m_gameExecutableDirectoryPath = directoryPath;

	std::string formattedGameExecutableDirectoryPath(Utilities::trimString(directoryPath));

	if(m_gameExecutableDirectoryPath.has_value() && Utilities::areStringsEqual(m_gameExecutableDirectoryPath.value(), formattedGameExecutableDirectoryPath)) {
		return;
	}

	m_gameExecutableDirectoryPath = std::move(formattedGameExecutableDirectoryPath);

	setModified(true);
}

void GameVersion::clearGameExecutableDirectoryPath() {
	if(!m_gameExecutableDirectoryPath.has_value()) {
		return;
	}

	m_gameExecutableDirectoryPath.reset();
...
const std::string & GameVersion::getGameConfigurationFileName() const {
	return m_gameConfigurationFileName;
}

bool GameVersion::setGameConfigurationFileName(const std::string & fileName) {
	...
	if(Utilities::areStringsEqual(m_gameConfigurationFileName, formattedFileName)) {
		return true;
	}

	m_gameConfigurationFileName = formattedFileName;
...
const std::optional<std::string> & GameVersion::getUnevaluatedGameConfigurationDirectoryPath() const {
	return m_gameConfigurationDirectoryPath;
}

std::optional<std::string> GameVersion::getEvaluatedGameConfigurationDirectoryPath() const {
	if(!m_gameConfigurationDirectoryPath.has_value()) {
		return {};
	}

	if(std::regex_match(m_gameConfigurationDirectoryPath.value(), GAME_CFG_VARIABLE_REGEX)) {
		spdlog::error("Cannot use '{}' variable name inside of game configuration directory path.", GAME_CFG_VARIABLE_NAME);
		return {};
	}

	return evaluateFilePath(m_gameConfigurationDirectoryPath.value());
}

std::optional<std::string> GameVersion::getEvaluatedGameConfigurationFilePath() const {
	std::optional<std::string> optionalEvaluatedGameConfigurationDirectoryPath(getEvaluatedGameConfigurationDirectoryPath());

	if(!optionalEvaluatedGameConfigurationDirectoryPath.has_value() || optionalEvaluatedGameConfigurationDirectoryPath->empty()) {
		return m_gameConfigurationFileName;
	}

	return Utilities::joinPaths(optionalEvaluatedGameConfigurationDirectoryPath.value(), m_gameConfigurationFileName);
}

bool GameVersion::setGameConfigurationDirectoryPath(const std::string & directoryPath) {
	std::string formattedDirectoryPath(Utilities::trimString(directoryPath));

	if(m_gameConfigurationDirectoryPath.has_value() && Utilities::areStringsEqual(m_gameConfigurationDirectoryPath.value(), formattedDirectoryPath)) {
		return true;
	}

	m_gameConfigurationDirectoryPath = formattedDirectoryPath;
...
void GameVersion::clearGameConfigurationDirectoryPath() {
	if(!m_gameConfigurationDirectoryPath.has_value()) {
		return;
	}

	m_gameConfigurationDirectoryPath.reset();
...
const std::optional<std::string> & GameVersion::getUnevaluatedGroupFileInstallPath() const {
	return m_groupFileInstallPath;
}

std::optional<std::string> GameVersion::getEvaluatedGroupFileInstallPath() const {
	if(!m_groupFileInstallPath.has_value()) {
		return {};
	}

	return evaluateFilePath(m_groupFileInstallPath.value());
}
...
bool GameVersion::hasAlternateModFilesInstallPath() const {
	return m_alternateModFilesInstallPath.has_value();
}

const std::optional<std::string> & GameVersion::getUnevaluatedAlternateModFilesInstallPath() const {
	return m_alternateModFilesInstallPath;
}

std::optional<std::string> GameVersion::getEvaluatedAlternateModFilesInstallPath() const {
	if(!m_alternateModFilesInstallPath.has_value()) {
		return {};
	}

	return evaluateFilePath(m_alternateModFilesInstallPath.value());
}

void GameVersion::setAlternateModFilesInstallPath(const std::string & alternateModFilesInstallPath) {
	std::string formattedAlternateModFilesInstallPath(Utilities::trimString(alternateModFilesInstallPath));

	if(m_alternateModFilesInstallPath.has_value() && Utilities::areStringsEqual(m_alternateModFilesInstallPath.value(), formattedAlternateModFilesInstallPath)) {
		return;
	}

	m_alternateModFilesInstallPath = std::move(formattedAlternateModFilesInstallPath);

	setModified(true);
}

void GameVersion::clearAlternateModFilesInstallPath() {
	if(!m_alternateModFilesInstallPath.has_value()) {
		return;
	}

	m_alternateModFilesInstallPath.reset();

	setModified(true);
}

bool GameVersion::hasGroupFileMaximum() const {
	return m_maximumGroupFiles.has_value();
}

const std::optional<uint16_t> & GameVersion::getMaximumGroupFiles() const {
...
void GameVersion::clearMaximumGroupFiles() {
	if(!m_maximumGroupFiles.has_value()) {
		return;
	}

	m_maximumGroupFiles.reset();

	setModified(true);
}

bool GameVersion::doesRequireOriginalGameFiles() const {
	return m_requiresOriginalGameFiles.value_or(false);
}
...
bool GameVersion::doesRequireGroupFileExtraction() const {
	return m_requiresGroupFileExtraction.value_or(false);
}
...
bool GameVersion::areScriptFilesReadFromGroup() const {
	if(isStandAlone()) {
		return false;
	}

	return m_scriptFilesReadFromGroup.value_or(false);
}
...
void GameVersion::setScriptFilesReadFromGroup(bool scriptFilesReadFromGroup) {
	if(m_scriptFilesReadFromGroup == scriptFilesReadFromGroup) {
		return;
	}
...
void GameVersion::clearScriptFilesReadFromGroup() {
	if(!m_scriptFilesReadFromGroup.has_value()) {
		return;
	}

	m_scriptFilesReadFromGroup.reset();
...
bool GameVersion::areZipArchiveGroupsSupported() const {
	if(isStandAlone()) {
		return false;
	}

	return m_zipArchiveGroupsSupported.value_or(false);
}

std::optional<bool> GameVersion::getZipArchiveGroupsSupported() const {
	if(isStandAlone()) {
		return {};
	}

	return m_zipArchiveGroupsSupported;
}

void GameVersion::setZipArchiveGroupsSupported(bool zipArchiveGroupsSupported) {
	if(m_zipArchiveGroupsSupported == zipArchiveGroupsSupported) {
		return;
	}
...
void GameVersion::clearZipArchiveGroupsSupported() {
	if(!m_zipArchiveGroupsSupported.has_value()) {
		return;
	}

	m_zipArchiveGroupsSupported.reset();
...
bool GameVersion::hasEpisodeArgumentFlag() const {
	return m_episodeArgumentFlag.has_value();
}

const std::optional<std::string> & GameVersion::getEpisodeArgumentFlag() const {
...
bool GameVersion::setEpisodeArgumentFlag(const std::string & flag) {
	...
	if(m_episodeArgumentFlag.has_value() && Utilities::areStringsEqual(m_episodeArgumentFlag.value(), flag)) {
		return true;
	}
...
void GameVersion::clearEpisodeArgumentFlag() {
	if(!m_episodeArgumentFlag.has_value()) {
		return;
	}

	m_episodeArgumentFlag.reset();

	setModified(true);
}

bool GameVersion::hasLevelArgumentFlag() const {
	return m_levelArgumentFlag.has_value();
}

const std::optional<std::string> & GameVersion::getLevelArgumentFlag() const {
...
bool GameVersion::setLevelArgumentFlag(const std::string & flag) {
	...
	if(m_levelArgumentFlag.has_value() && Utilities::areStringsEqual(m_levelArgumentFlag.value(), flag)) {
		return true;
	}
...
void GameVersion::clearLevelArgumentFlag() {
	if(!m_levelArgumentFlag.has_value()) {
		return;
	}

	m_levelArgumentFlag.reset();

	setModified(true);
}

bool GameVersion::hasSkillArgumentFlag() const {
	return m_skillArgumentFlag.has_value();
}

const std::optional<std::string> & GameVersion::getSkillArgumentFlag() const {
...
bool GameVersion::setSkillArgumentFlag(const std::string & flag) {
	...
	if(m_skillArgumentFlag.has_value() && Utilities::areStringsEqual(m_skillArgumentFlag.value(), flag)) {
		return true;
	}
...
void GameVersion::clearSkillArgumentFlag() {
	if(!m_skillArgumentFlag.has_value()) {
		return;
	}

	m_skillArgumentFlag.reset();

	setModified(true);
}

bool GameVersion::hasSkillStartValue() const {
	return m_skillStartValue.has_value();
}

std::optional<uint8_t> GameVersion::getSkillStartValue() const {
	return m_skillStartValue;
}

void GameVersion::setSkillStartValue(uint8_t skillStartValue) {
	if(m_skillStartValue.has_value() && m_skillStartValue.value() == skillStartValue) {
		return;
	}
...
void GameVersion::clearSkillStartValue() {
	if(!m_skillStartValue.has_value()) {
		return;
	}

	m_skillStartValue.reset();
...
std::optional<std::string> GameVersion::evaluateFilePath(const std::string & filePath) const {
	FilePathVariableEvaluator::VariableMap variableMap({
		{ "GAMEID", m_id }
	});

	if(std::regex_match(filePath, GAME_CFG_VARIABLE_REGEX)) {
		std::optional<std::string> optionalEvaluatedGameConfigurationFilePath(getEvaluatedGameConfigurationFilePath());

		if(optionalEvaluatedGameConfigurationFilePath.has_value()) {
			std::string gameConfigurationFilePath(std::move(optionalEvaluatedGameConfigurationFilePath.value()));
			...
			if(!isGameConfigurationFilePathAbsolute) {
				if(isConfigured()) {
					std::optional<std::string> optionalEvaluatedGamePath(getEvaluatedGamePath());

					if(optionalEvaluatedGamePath.has_value()) {
						gameConfigurationFilePath = Utilities::joinPaths(optionalEvaluatedGamePath.value(), gameConfigurationFilePath);
					}
					else {
						spdlog::error("Failed to evaluate '{}' game path.", m_longName);
						return {};
					}
				}
				else {
					spdlog::error("Cannot evaluate unconfigured '{}' game version game path.");
					return {};
				}
			}

			if(!std::filesystem::is_regular_file(std::filesystem::path(gameConfigurationFilePath))) {
				spdlog::error("Cannot evaluate '{}' variable in '{}' game version file path due to missing game configuration file: '{}'.", GAME_CFG_VARIABLE_NAME, m_longName, gameConfigurationFilePath);
				return {};
			}

			std::unique_ptr<GameConfiguration> gameConfiguration(GameConfiguration::loadFrom(gameConfigurationFilePath));

			if(!GameConfiguration::isValid(gameConfiguration.get())) {
				spdlog::error("Cannot evaluate '{}' variable in '{}' game version file path due to invalid game configuration file: '{}'.", GAME_CFG_VARIABLE_NAME, m_longName, gameConfigurationFilePath);
				return {};
			}

			for(size_t i = 0; i < gameConfiguration->numberOfSections(); i++) {
				std::shared_ptr<GameConfiguration::Section> section(gameConfiguration->getSection(i));
				const std::vector<std::shared_ptr<GameConfiguration::Entry>> & entries = section->getEntries();

				for(const std::shared_ptr<GameConfiguration::Entry> & entry : entries) {
					if(entry->isString()) {
						variableMap.emplace(fmt::format("{}:{}:{}", GAME_CFG_VARIABLE_NAME, section->getName(), entry->getName()), entry->getStringValue());
					}
				}
			}
		}
	...
	return FilePathVariableEvaluator::getInstance()->evaluateFilePath(filePath, variableMap);
}
...
size_t GameVersion::numberOfConflictingGameFiles() const {
	return m_conflictingGameFiles.size();
}

bool GameVersion::hasConflictingGameFiles() const {
	return !m_conflictingGameFiles.empty();
}

bool GameVersion::hasConflictingGameFile(const std::string & filePath) const {
	return indexOfConflictingGameFile(filePath) != std::numeric_limits<size_t>::max();
}

size_t GameVersion::indexOfConflictingGameFile(const std::string & filePath) const {
	auto conflictingGameFilesIterator = std::find_if(m_conflictingGameFiles.cbegin(), m_conflictingGameFiles.cend(), [&filePath](const std::string & currentConflictingGameFilePath) {
		return Utilities::areStringsEqual(filePath, currentConflictingGameFilePath);
	});

	if(conflictingGameFilesIterator == m_conflictingGameFiles.cend()) {
		return std::numeric_limits<size_t>::max();
	}

	return conflictingGameFilesIterator - m_conflictingGameFiles.cbegin();
}

std::string GameVersion::getConflictingGameFile(size_t index) const {
	if(index >= m_conflictingGameFiles.size()) {
		return {};
	}

	return m_conflictingGameFiles[index];
}

const std::vector<std::string> & GameVersion::getConflictingGameFiles() const {
	return m_conflictingGameFiles;
}

bool GameVersion::addConflictingGameFile(const std::string & filePath) {
	if(filePath.empty() || hasConflictingGameFile(filePath)) {
		return false;
	}

	m_conflictingGameFiles.emplace_back(filePath);
...
bool GameVersion::removeConflictingGameFile(size_t index) {
	if(index >= m_conflictingGameFiles.size()) {
		return false;
	}

	m_conflictingGameFiles.erase(m_conflictingGameFiles.begin() + index);
...
bool GameVersion::removeConflictingGameFile(const std::string & filePath) {
	return removeConflictingGameFile(indexOfConflictingGameFile(filePath));
}

void GameVersion::clearConflictingGameFiles() {
	if(m_conflictingGameFiles.empty()) {
		return;
	}

	m_conflictingGameFiles.clear();
...
bool GameVersion::isDefaultGameVersionWithIDInstallable(const std::string & gameVersionID) {
	const GameVersion * defaultGameVersion = getDefaultGameVersionWithID(gameVersionID);

	return defaultGameVersion != nullptr &&
		   defaultGameVersion->isInstallable();
}

std::optional<std::string> GameVersion::getEvaluatedGameExecutableDirectoryPathForDefaultGameVersionWithID(const std::string & gameVersionID) {
	for(const GameVersion * gameVersion : DEFAULT_GAME_VERSIONS) {
		if(Utilities::areStringsEqual(gameVersion->getID(), gameVersionID)) {
			return gameVersion->getEvaluatedGameExecutableDirectoryPath();
		}
	}
...
std::optional<std::string> GameVersion::getEvaluatedGroupFileInstallPathForDefaultGameVersionNameWithID(const std::string & gameVersionID) {
	for(const GameVersion * gameVersion : DEFAULT_GAME_VERSIONS) {
		if(Utilities::areStringsEqual(gameVersion->getID(), gameVersionID)) {
			return gameVersion->getEvaluatedGroupFileInstallPath();
		}
	}
...
const GameVersion * GameVersion::getDefaultGameVersionWithID(const std::string & gameVersionID) {
	for(const GameVersion * gameVersion : DEFAULT_GAME_VERSIONS) {
		if(Utilities::areStringsEqual(gameVersion->getID(), gameVersionID)) {
			return gameVersion;
		}
...
void GameVersion::addMetadata(std::map<std::string, std::any> & metadata) const {
	...
	metadata["installable"] = m_installable;
	metadata["removable"] = m_removable;
	metadata["standAlone"] = m_standAlone;
	...
	if(m_gameExecutableDirectoryPath.has_value()) {
		metadata["gameExecutableDirectoryPath"] = m_gameExecutableDirectoryPath;
	}
	...
	metadata["gameConfigurationFileName"] = m_gameConfigurationFileName;
	...
	if(m_alternateModFilesInstallPath.has_value()) {
		metadata["alternateModFilesInstallPath"] = m_alternateModFilesInstallPath.value();
	}
	...
	if(m_scriptFilesReadFromGroup.has_value()) {
		metadata["scriptFilesReadFromGroup"] = m_scriptFilesReadFromGroup.value();
	}
	...
	if(m_zipArchiveGroupsSupported.has_value()) {
		metadata["zipArchiveGroupsSupported"] = m_zipArchiveGroupsSupported.value();
	}
	...
	if(m_episodeArgumentFlag.has_value()) {
		metadata["episodeArgumentFlag"] = m_episodeArgumentFlag.value();
	}

	if(m_levelArgumentFlag.has_value()) {
		metadata["levelArgumentFlag"] = m_levelArgumentFlag.value();
	}

	if(m_skillArgumentFlag.has_value()) {
		metadata["skillArgumentFlag"] = m_skillArgumentFlag.value();
	}
...
std::unique_ptr<GameVersion> GameVersion::createTemplateFrom() const {
	return std::make_unique<GameVersion>(
		...
		m_gameExecutableDirectoryPath,
		m_gameConfigurationFileName,
		m_gameConfigurationDirectoryPath,
		m_localWorkingDirectory,
		m_scriptFilesReadFromGroup,
		m_supportsSubdirectories,
		m_worldTourGroupSupported,
		m_zipArchiveGroupsSupported,
		m_maximumGroupFiles,
		Utilities::emptyString,
		...
		m_alternateModFilesInstallPath,
...
size_t GameVersion::checkForMissingExecutables() const {
	...
	std::string fullGameExecutablePath(Utilities::joinPaths(m_gamePath, m_gameExecutableDirectoryPath.value_or(""), m_gameExecutableName));
...
rapidjson::Value GameVersion::toJSON(rapidjson::MemoryPoolAllocator<rapidjson::CrtAllocator> & allocator) const {
	...
	if(m_gameExecutableDirectoryPath.has_value()) {
		rapidjson::Value gameExecutableDirectoryPathValue(m_gameExecutableDirectoryPath.value().c_str(), allocator);
		gameVersionValue.AddMember(rapidjson::StringRef(JSON_GAME_EXECUTABLE_DIRECTORY_PATH_PROPERTY_NAME), gameExecutableDirectoryPathValue, allocator);
	}
	...
	if(m_scriptFilesReadFromGroup.has_value()) {
		gameVersionValue.AddMember(rapidjson::StringRef(JSON_SCRIPT_FILES_READ_FROM_GROUP_PROPERTY_NAME), rapidjson::Value(m_scriptFilesReadFromGroup.value()), allocator);
	}
	...
	if(m_zipArchiveGroupsSupported.has_value()) {
		gameVersionValue.AddMember(rapidjson::StringRef(JSON_SUPPORTS_ZIP_ARCHIVE_GROUPS_PROPERTY_NAME), rapidjson::Value(m_zipArchiveGroupsSupported.value()), allocator);
	}
	...
	rapidjson::Value gameConfigurationFileNameValue(m_gameConfigurationFileName.c_str(), allocator);
	gameVersionValue.AddMember(rapidjson::StringRef(JSON_GAME_CONFIGURATION_FILE_NAME_PROPERTY_NAME), gameConfigurationFileNameValue, allocator);

	if(m_gameConfigurationDirectoryPath.has_value()) {
		rapidjson::Value gameConfigurationDirectoryPathValue(m_gameConfigurationDirectoryPath->c_str(), allocator);
		gameVersionValue.AddMember(rapidjson::StringRef(JSON_GAME_CONFIGURATION_DIRECTORY_PATH_PROPERTY_NAME), gameConfigurationDirectoryPathValue, allocator);
	}
	...
	if(m_alternateModFilesInstallPath.has_value()) {
		rapidjson::Value alternateModFilesInstallPathValue(m_alternateModFilesInstallPath.value().c_str(), allocator);
		gameVersionValue.AddMember(rapidjson::StringRef(JSON_ALTERNATE_MOD_FILES_INSTALL_PATH_PROPERTY_NAME), alternateModFilesInstallPathValue, allocator);
	}
	...
	if(!m_conflictingGameFiles.empty()) {
		rapidjson::Value conflictingGameFilesValue(rapidjson::kArrayType);
		conflictingGameFilesValue.Reserve(m_conflictingGameFiles.size(), allocator);

		for(const std::string & conflictingGameFile : m_conflictingGameFiles) {
			rapidjson::Value conflictingGameFileValue(conflictingGameFile.c_str(), allocator);
			conflictingGameFilesValue.PushBack(conflictingGameFileValue, allocator);
		}

		gameVersionValue.AddMember(rapidjson::StringRef(JSON_CONFLICTING_GAME_FILES_PROPERTY_NAME), conflictingGameFilesValue, allocator);
	}
...
std::unique_ptr<GameVersion> GameVersion::parseFrom(const rapidjson::Value & gameVersionValue) {
	...
	// parse game version game executable directory path
	std::optional<std::string> gameExecutableDirectoryPathOptional;

	if(gameVersionValue.HasMember(JSON_GAME_EXECUTABLE_DIRECTORY_PATH_PROPERTY_NAME)) {
		const rapidjson::Value & gameExecutableDirectoryPathValue = gameVersionValue[JSON_GAME_EXECUTABLE_DIRECTORY_PATH_PROPERTY_NAME];

		if(!gameExecutableDirectoryPathValue.IsString()) {
			spdlog::error("Game version with ID '{}' has an invalid '{}' property type: '{}', expected 'string'.", id, JSON_GAME_EXECUTABLE_DIRECTORY_PATH_PROPERTY_NAME, Utilities::typeToString(gameExecutableDirectoryPathValue.GetType()));
			return nullptr;
		}

		gameExecutableDirectoryPathOptional = Utilities::trimString(gameExecutableDirectoryPathValue.GetString());
	}
	...
	// parse game version game configuration file name
	if(!gameVersionValue.HasMember(JSON_GAME_CONFIGURATION_FILE_NAME_PROPERTY_NAME)) {
		spdlog::error("Game version with ID '{}' is missing '{}' property.", id, JSON_GAME_CONFIGURATION_FILE_NAME_PROPERTY_NAME);
		return nullptr;
	}

	const rapidjson::Value & gameConfigurationFileNameValue = gameVersionValue[JSON_GAME_CONFIGURATION_FILE_NAME_PROPERTY_NAME];

	if(!gameConfigurationFileNameValue.IsString()) {
		spdlog::error("Game version with ID '{}' has an invalid '{}' property type: '{}', expected 'string'.", id, JSON_GAME_CONFIGURATION_FILE_NAME_PROPERTY_NAME, Utilities::typeToString(gameConfigurationFileNameValue.GetType()));
		return nullptr;
	}

	std::string gameConfigurationFileName(Utilities::trimString(gameConfigurationFileNameValue.GetString()));

	if(gameConfigurationFileName.empty()) {
		spdlog::error("Game version with ID '{}' '{}' property cannot be empty.", id, JSON_GAME_CONFIGURATION_FILE_NAME_PROPERTY_NAME);
		return nullptr;
	}

	// parse game version game configuration directory path
	std::optional<std::string> gameConfigurationDirectoryPathOptional;

	if(gameVersionValue.HasMember(JSON_GAME_CONFIGURATION_DIRECTORY_PATH_PROPERTY_NAME)) {
		const rapidjson::Value & gameConfigurationDirectoryPathValue = gameVersionValue[JSON_GAME_CONFIGURATION_DIRECTORY_PATH_PROPERTY_NAME];

		if(!gameConfigurationDirectoryPathValue.IsString()) {
			spdlog::error("Game version with ID '{}' has an invalid '{}' property type: '{}', expected 'string'.", id, JSON_GAME_CONFIGURATION_DIRECTORY_PATH_PROPERTY_NAME, Utilities::typeToString(gameConfigurationDirectoryPathValue.GetType()));
			return nullptr;
		}

		gameConfigurationDirectoryPathOptional = Utilities::trimString(gameConfigurationDirectoryPathValue.GetString());
	}
	...
	std::optional<std::string> optionalGroupFileInstallPath;
	...
	if(gameVersionValue.HasMember(JSON_GROUP_FILE_INSTALL_PATH_PROPERTY_NAME)) {
		...
		optionalGroupFileInstallPath = Utilities::trimString(groupFileInstallPathValue.GetString());
	}

	// parse alternate mod files install path
	std::optional<std::string> optionalAlternateModFilesInstallPath;

	if(gameVersionValue.HasMember(JSON_ALTERNATE_MOD_FILES_INSTALL_PATH_PROPERTY_NAME)) {
		const rapidjson::Value & alternateModFilesInstallPathValue = gameVersionValue[JSON_ALTERNATE_MOD_FILES_INSTALL_PATH_PROPERTY_NAME];

		if(!alternateModFilesInstallPathValue.IsString()) {
			spdlog::error("Game version with ID '{}' has an invalid '{}' property type: '{}', expected 'string'.", id, JSON_ALTERNATE_MOD_FILES_INSTALL_PATH_PROPERTY_NAME, Utilities::typeToString(alternateModFilesInstallPathValue.GetType()));
			return nullptr;
		}

		optionalAlternateModFilesInstallPath = Utilities::trimString(alternateModFilesInstallPathValue.GetString());
	}
	...
	// parse script files read from group option
	std::optional<bool> scriptFilesReadFromGroup;

	if(gameVersionValue.HasMember(JSON_SCRIPT_FILES_READ_FROM_GROUP_PROPERTY_NAME)) {
		const rapidjson::Value & scriptFilesReadFromGroupValue = gameVersionValue[JSON_SCRIPT_FILES_READ_FROM_GROUP_PROPERTY_NAME];

		if(!scriptFilesReadFromGroupValue.IsBool()) {
			spdlog::error("Game version with ID '{}' has an invalid '{}' property type: '{}', expected 'boolean'.", id, JSON_SCRIPT_FILES_READ_FROM_GROUP_PROPERTY_NAME, Utilities::typeToString(scriptFilesReadFromGroupValue.GetType()));
			return nullptr;
		}

		scriptFilesReadFromGroup = scriptFilesReadFromGroupValue.GetBool();
	}
	...
	// parse supports zip archive groups option
	std::optional<bool> zipArchiveGroupsSupported;

	if(gameVersionValue.HasMember(JSON_SUPPORTS_ZIP_ARCHIVE_GROUPS_PROPERTY_NAME)) {
		const rapidjson::Value & zipArchiveGroupsSupportedValue = gameVersionValue[JSON_SUPPORTS_ZIP_ARCHIVE_GROUPS_PROPERTY_NAME];

		if(!zipArchiveGroupsSupportedValue.IsBool()) {
			spdlog::error("Game version with ID '{}' has an invalid '{}' property type: '{}', expected 'boolean'.", id, JSON_SUPPORTS_ZIP_ARCHIVE_GROUPS_PROPERTY_NAME, Utilities::typeToString(zipArchiveGroupsSupportedValue.GetType()));
			return nullptr;
		}

		zipArchiveGroupsSupported = zipArchiveGroupsSupportedValue.GetBool();
	}

	// parse the maximum group files property
	std::optional<uint16_t> optionalMaximumGroupFiles;

	if(gameVersionValue.HasMember(JSON_MAXIMUM_GROUP_FILES_PROPERTY_NAME)) {
		const rapidjson::Value & maximumGroupFilesValue = gameVersionValue[JSON_MAXIMUM_GROUP_FILES_PROPERTY_NAME];

		if(!maximumGroupFilesValue.IsUint()) {
			spdlog::error("Game version with ID '{}' '{}' property has invalid type: '{}', expected unsigned integer 'number'.", id, JSON_MAXIMUM_GROUP_FILES_PROPERTY_NAME, Utilities::typeToString(maximumGroupFilesValue.GetType()));
			return nullptr;
		}

		uint32_t maximumGroupFiles = maximumGroupFilesValue.GetUint();

		if(maximumGroupFiles > std::numeric_limits<uint16_t>::max()) {
			spdlog::error("Game version with ID '{}' '{}' property value of {} exceeds limit of {}.", id, JSON_MAXIMUM_GROUP_FILES_PROPERTY_NAME, maximumGroupFiles, std::numeric_limits<uint16_t>::max());
			return nullptr;
		}

		optionalMaximumGroupFiles = static_cast<uint16_t>(maximumGroupFilesValue.GetUint());
	}
	...
	std::optional<std::string> optionalEpisodeArgumentFlag;
	...
	if(gameVersionValue.HasMember(JSON_EPISODE_ARGUMENT_FLAG_PROPERTY_NAME)) {
		...
		optionalEpisodeArgumentFlag = episodeArgumentFlagValue.GetString();

		if(optionalEpisodeArgumentFlag.value().empty()) {
	...
	std::optional<std::string> optionalLevelArgumentFlag;
	...
	if(gameVersionValue.HasMember(JSON_LEVEL_ARGUMENT_FLAG_PROPERTY_NAME)) {
		...
		optionalLevelArgumentFlag = levelArgumentFlagValue.GetString();

		if(optionalLevelArgumentFlag->empty()) {
	...
	if(gameVersionValue.HasMember(JSON_SKILL_ARGUMENT_FLAG_PROPERTY_NAME)) {
		...
		optionalSkillArgumentFlag = skillArgumentFlagValue.GetString();

		if(optionalSkillArgumentFlag->empty()) {
	...
	std::optional<uint8_t> optionalSkillStartValue;
	...
	if(gameVersionValue.HasMember(JSON_SKILL_START_VALUE_PROPERTY_NAME)) {
		...
		optionalSkillStartValue = static_cast<uint8_t>(tempSkillStartValue);
	}
	else if(optionalSkillArgumentFlag.has_value()) {
	...
	// parse the conflicting game files property
	if(gameVersionValue.HasMember(JSON_CONFLICTING_GAME_FILES_PROPERTY_NAME)) {
		const rapidjson::Value & conflictingGameFilesValue = gameVersionValue[JSON_CONFLICTING_GAME_FILES_PROPERTY_NAME];

		if(!conflictingGameFilesValue.IsArray()) {
			spdlog::error("Game version with ID '{}' '{}' property has invalid type: '{}', expected 'array'.", id, JSON_CONFLICTING_GAME_FILES_PROPERTY_NAME, Utilities::typeToString(conflictingGameFilesValue.GetType()));
			return nullptr;
		}

		for(rapidjson::Value::ConstValueIterator i = conflictingGameFilesValue.Begin(); i != conflictingGameFilesValue.End(); ++i) {
			std::string conflictingGameFile(Utilities::trimString((*i).GetString()));

			if(conflictingGameFile.empty()) {
				spdlog::error("Encountered empty conflicting game file #{} for game version with ID '{}'.", newGameVersion->m_conflictingGameFiles.size() + 1, id);
				return nullptr;
			}

			if(newGameVersion->hasConflictingGameFile(conflictingGameFile)) {
				spdlog::error("Encountered duplicate conflicting game file #{} for game version with ID '{}'.", newGameVersion->m_conflictingGameFiles.size() + 1, id);
				return nullptr;
			}

			newGameVersion->m_conflictingGameFiles.emplace_back(conflictingGameFile);
		}
	}
...
bool GameVersion::operator == (const GameVersion & gameVersion) const {
	if(m_standAlone != gameVersion.m_standAlone ||
	   ...
	   m_gameExecutableDirectoryPath != gameVersion.m_gameExecutableDirectoryPath ||
	   m_setupExecutableName != gameVersion.m_setupExecutableName ||
	   !Utilities::areStringsEqual(m_gameConfigurationFileName, gameVersion.m_gameConfigurationFileName) ||
	   m_gameConfigurationDirectoryPath != gameVersion.m_gameConfigurationDirectoryPath ||
