...
static const std::array<std::string_view, 45> JSON_PROPERTY_NAMES = {
...
const GameVersion GameVersion::LAMEDUKE                ("lameduke",   "Duke Nukem 3D Beta 1.3.95 (LameDuke)",       "LameDuke",                 false, "", "D3D.EXE",            "SETUP.DAT",                          "",                                          true,  {},    false, {},    {},    "LameDuke",  {},    {},     {},    {},      "/v", "/l", "/s", 0, "/r", {},    {},   {},   {},   {},    {},    "SETUP.EXE", {}, {},    {},     {},    true, "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { },                                                                                                                                      { },                                                                                      { DOSBoxConfiguration({ DOSBoxConfiguration::Section("cpu", { DOSBoxConfiguration::Section::Entry("cycles", "50000") }) }) });
const GameVersion GameVersion::ORIGINAL_BETA_VERSION   ("beta",       "Duke Nukem 3D Beta 0.99",                    "Duke 3D Beta 0.99",        true,  "", "DUKE3D.EXE",         GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    false, {},    {},    "Beta",      {},    {},     {},    {},      "/v", "/l", "/s", 0, "/r", {},    "/t", {},   "/m", {},    {},    "SETUP.EXE", "", {},    {},     {},    true, "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { REGULAR_ID },                                                                                                                           { "Has extremely poor support for mods.", "Does not function properly out of the box." });
const GameVersion GameVersion::ORIGINAL_REGULAR_VERSION(REGULAR_ID,   "Duke Nukem 3D 1.3D",                         "Duke 3D 1.3D",             false, "", "DUKE3D.EXE",         GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    true,  {},    {},    "Regular",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", {},    "/t", "/u", "/m", "/ns", "/nm", "SETUP.EXE", "", {},    {},     true,  {},   "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { ORIGINAL_BETA_VERSION.getID() });
const GameVersion GameVersion::ORIGINAL_PLUTONIUM_PAK  ("plutonium",  "Duke Nukem 3D: Plutonium Pak 1.4",           "Plutonium Pak",            true,  "", "DUKE3D.EXE",         GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    true,  false, {},    "PlutPak",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", "SETUP.EXE", "", {},    {},     {},    {},   "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { ATOMIC_ID },                                                                                                                            { "Virtually identical to Duke Nukem 3D Atomic Edition." });
const GameVersion GameVersion::ORIGINAL_ATOMIC_EDITION (ATOMIC_ID,    "Duke Nukem 3D: Atomic Edition 1.5",          "Atomic Edition",           false, "", "DUKE3D.EXE",         GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    true,  true,  {},    "Atomic",    "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", "SETUP.EXE", "", {},    {},     {},    {},   "https://www.dukenukem.com",                                     "",                                                                         { OperatingSystem::DOS },                                                     { ORIGINAL_PLUTONIUM_PAK.getID() });
const GameVersion GameVersion::JFDUKE3D                ("jfduke3d",   "JFDuke3D",                                   "JFDuke3D",                 false, "", "duke3d.exe",         GameConfiguration::DEFAULT_FILE_NAME, ":APPDATA:/:GAMEID:",                        true,  {},    true,  true,  {},    "JFDuke3D",  "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          {}, {},    {},     {},    {},   "http://www.jonof.id.au/jfduke3d",                               "https://github.com/jonof/jfduke3d",                                        { OperatingSystem::Windows, OperatingSystem::MacOS },                         { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::EDUKE32                 ("eduke32",    "eDuke32",                                    "eDuke32",                  false, "", "eduke32.exe",        "eduke32.cfg",                        "",                                          false, true,  true,  true,  true,  "eDuke32",   "-x ", "-mx ", "-g ", "-map ", "-v", "-l", "-s", 1, "-r", "-d ", "-t", "-u", "-m", "-ns", "-nm", {},          {}, "-h ", "-mh ", {},    {},   "https://www.eduke32.com",                                       "https://voidpoint.io/terminx/eduke32",                                     { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() });
const GameVersion GameVersion::NETDUKE32               ("netduke32",  "NetDuke32",                                  "NetDuke32",                true,  "", "netduke32.exe",      "netduke32.cfg",                      "",                                          false, true,  true,  true,  true,  "NetDuke",   "-x ", "-mx ", "-g ", "-map ", "-v", "-l", "-s", 1, "-r", "-d ", "-t", "-u", "-m", "-ns", "-nm", {},          {}, "-h ", "-mh ", {},    {},   "https://wiki.eduke32.com/wiki/NetDuke32",                       "https://voidpoint.io/StrikerTheHedgefox/eduke32-csrefactor/-/tree/master", { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID(), EDUKE32.getID() });
//const GameVersion GameVersion::MEGATON_EDITION         ("megaton",    "Duke Nukem 3D: Megaton Edition",             "Megaton Edition",          true,  "", "duke3d.exe",         GameConfiguration::DEFAULT_FILE_NAME, "../gameroot",                               true,  {},    true,  true,  {},    "Megaton",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          {}, {},    {},     {},    {},   "https://store.steampowered.com/app/225140",                     "https://github.com/TermiT/duke3d-megaton",                                 { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() });
...
const GameVersion GameVersion::RED_NUKEM               ("rednukem",   "RedNukem",                                   "RedNukem",                 true,  "", "rednukem.exe",       "rednukem.cfg",                       "",                                          false, true,  true,  true,  {},    "RedNukem",  "-x ", "-mx ", "-g ", "-map ", "-v", "-l", "-s", 1, "-r", "-d ", "-t", "-u", "-m", "-ns", "-nm", {},          {}, "-h ", "-mh ", {},    {},   "https://lerppu.net/wannabethesis",                              "https://github.com/nukeykt/NRedneck",                                      { OperatingSystem::Windows },                                                 { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(),  JFDUKE3D.getID() });
//const GameVersion GameVersion::CHOCOLATE_DUKE3D        ("chocolate",  "Chocolate Duke Nukem 3D",                    "Chocolate Duke3D",         true,  "", "Game.exe",           GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    false, true,  {},    "Chocolate", "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          {}, {},    {},     {},    {},   "https://fabiensanglard.net/duke3d/chocolate_duke_nukem_3D.php", "https://github.com/fabiensanglard/chocolate_duke3D",                       { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::BELGIAN_CHOCOLATE_DUKE3D("belgian",    "Belgian Chocolate Duke Nukem 3D",            "Belgian Chocolate Duke3D", true,  "", "ChocoDuke3D.64.exe", GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    false, true,  {},    "Belgian",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},    {},     {},    {},   "",                                                              "https://github.com/GPSnoopy/BelgianChocolateDuke3D",                       { OperatingSystem::Windows, OperatingSystem::Linux, OperatingSystem::MacOS }, { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::DUKE3DW                 ("duke3dw",    "Duke3dw",                                    "Duke3dw",                  true,  "", "Duke3dw.exe",        "Duke3dw.cfg",                        "",                                          true,  {},    true,  true,  {},    "Duke3dw",   "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", "/h",  {},     {},    {},   "http://www.proasm.com/duke/Duke3dw.html",                       "",                                                                         { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() });
const GameVersion GameVersion::PKDUKE3D                ("pkduke3d",   "pkDuke3D",                                   "pkDuke3D",                 true,  "", "pkDuke3d.exe",       GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    true,  true,  {},    "pkDuke3D",  "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},    {},     {},    {},   "https://bitbucket.org/pogokeen/pkduke3d/downloads",             "https://bitbucket.org/pogokeen/pkduke3d",                                  { OperatingSystem::Windows },                                                 { ORIGINAL_REGULAR_VERSION.getID(), ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID(), JFDUKE3D.getID() },                  { "Has some issues running mods, such as missing episode names." });
const GameVersion GameVersion::XDUKE                   ("xduke",      "xDuke",                                      "xDuke",                    true,  "", "duke3d_w32.exe",     GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    false, false, {},    "xDuke",     "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},    {},     {},    {},   "http://vision.gel.ulaval.ca/~klein/duke3d",                     "",                                                                         { OperatingSystem::Windows },                                                 { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::RDUKE                   ("rduke",      "rDuke",                                      "rDuke",                    true,  "", "rduke_r10.exe",      GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    false, false, {},    "rDuke",     "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},    {},     {},    {},   "",                                                              "https://github.com/radar-duker/radars-xduke-fork",                         { OperatingSystem::Windows },                                                 { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
const GameVersion GameVersion::DUKE3D_W32              ("duke3d_w32", "Duke3d_w32",                                 "Duke3d_w32",               true,  "", "duke3d_w32.exe",     GameConfiguration::DEFAULT_FILE_NAME, "",                                          true,  {},    false, true,  {},    "Duke_w32",  "/x",  {},     "/g",  "-map ", "/v", "/l", "/s", 1, "/r", "/d",  "/t", "/u", "/m", "/ns", "/nm", {},          "", {},    {},     {},    {},   "http://www.rancidmeat.com/project.php3?id=1",                   "",                                                                         { OperatingSystem::Windows },                                                 { ORIGINAL_PLUTONIUM_PAK.getID(), ORIGINAL_ATOMIC_EDITION.getID() });
...
GameVersion::GameVersion(const std::string & id, const std::string & longName, const std::string & shortName, bool removable, const std::string & gamePath, const std::string & gameExecutableName, const std::string & gameConfigurationFileName, const std::string & gameConfigurationDirectoryPath, bool localWorkingDirectory, std::optional<bool> scriptFilesReadFromGroup, bool supportsSubdirectories, std::optional<bool> worldTourGroupSupported, std::optional<bool> zipArchiveGroupsSupported, const std::string & modDirectoryName, const std::optional<std::string> & conFileArgumentFlag, const std::optional<std::string> & extraConFileArgumentFlag, const std::optional<std::string> & groupFileArgumentFlag, const std::optional<std::string> & mapFileArgumentFlag, const std::string & episodeArgumentFlag, const std::string & levelArgumentFlag, const std::string & skillArgumentFlag, uint8_t skillStartValue, const std::string & recordDemoArgumentFlag, const std::optional<std::string> & playDemoArgumentFlag, const std::optional<std::string> & respawnModeArgumentFlag, const std::optional<std::string> & weaponSwitchOrderArgumentFlag, const std::optional<std::string> & disableMonstersArgumentFlag, const std::optional<std::string> & disableSoundArgumentFlag, const std::optional<std::string> & disableMusicArgumentFlag, const std::optional<std::string> & setupExecutableName, const std::optional<std::string> & groupFileInstallPath, const std::optional<std::string> & defFileArgumentFlag, const std::optional<std::string> & extraDefFileArgumentFlag,const std::optional<bool> & requiresCombinedGroup, const std::optional<bool> & requiresGroupFileExtraction, const std::string & website, const std::string & sourceCodeURL, const std::vector<OperatingSystem> & supportedOperatingSystems, const std::vector<std::string> & compatibleGameVersionIdentifiers, const std::vector<std::string> & notes, const DOSBoxConfiguration & dosboxConfiguration)
