...
public:
	...
	static std::unique_ptr<ModVersion> parseFrom(const rapidjson::Value & modVersionValue);
	static std::unique_ptr<ModVersion> parseFrom(const tinyxml2::XMLElement * modVersionElement);
