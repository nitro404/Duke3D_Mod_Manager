...
GameVersionPanel::GameVersionPanel(std::shared_ptr<GameVersion> gameVersion, wxWindow * parent, wxWindowID windowID, const wxPoint & position, const wxSize & size, long style)
	...
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<void>(std::bind(&GameVersion::getGameExecutableDirectoryPath, m_gameVersion.get()), std::bind(&GameVersion::setGameExecutableDirectoryPath, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearGameExecutableDirectoryPath, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getGameExecutableDirectoryPath() : std::optional<std::string>(), "Game Executable Directory Path", gameConfigurationPanel, gameConfigurationSizer, 1));
	...
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<void>(std::bind(&GameVersion::getGameConfigurationDirectoryPath, m_gameVersion.get()), std::bind(&GameVersion::setGameConfigurationDirectoryPath, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearGameConfigurationDirectoryPath, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getGameConfigurationDirectoryPath() : std::optional<std::string>(), "Game Configuration Directory Path", gameConfigurationPanel, gameConfigurationSizer, 1));
