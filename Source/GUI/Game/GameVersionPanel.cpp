...
GameVersionPanel::GameVersionPanel(std::shared_ptr<GameVersion> gameVersion, wxWindow * parent, wxWindowID windowID, const wxPoint & position, const wxSize & size, long style)
	...
	m_settingsPanels.push_back(SettingPanel::createStringSettingPanel<void>(std::bind(&GameVersion::getUnevaluatedGamePath, m_gameVersion.get()), std::bind(&GameVersion::setGamePath, m_gameVersion.get(), std::placeholders::_1), defaultGameVersion != nullptr ? defaultGameVersion->getUnevaluatedGamePath() : "", "Game Path", gameConfigurationPanel, gameConfigurationSizer));
	...
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<void>(std::bind(&GameVersion::getUnevaluatedGameExecutableDirectoryPath, m_gameVersion.get()), std::bind(&GameVersion::setGameExecutableDirectoryPath, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearGameExecutableDirectoryPath, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getUnevaluatedGameExecutableDirectoryPath() : std::optional<std::string>(), "Game Executable Directory Path", gameConfigurationPanel, gameConfigurationSizer, 1));
	...
	m_settingsPanels.push_back(SettingPanel::createStringSettingPanel<void>(std::bind(&GameVersion::getGameConfigurationFileName, m_gameVersion.get()), std::bind(&GameVersion::setGameConfigurationFileName, m_gameVersion.get(), std::placeholders::_1), defaultGameVersion != nullptr ? defaultGameVersion->getGameConfigurationFileName() : "", "Game Configuration File Name", gameConfigurationPanel, gameConfigurationSizer, 1));
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<void>(std::bind(&GameVersion::getUnevaluatedGameConfigurationDirectoryPath, m_gameVersion.get()), std::bind(&GameVersion::setGameConfigurationDirectoryPath, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearGameConfigurationDirectoryPath, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getUnevaluatedGameConfigurationDirectoryPath() : std::optional<std::string>(), "Game Configuration Directory Path", gameConfigurationPanel, gameConfigurationSizer, 1));
	...
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<void>(std::bind(&GameVersion::getUnevaluatedGroupFileInstallPath, m_gameVersion.get()), std::bind(&GameVersion::setGroupFileInstallPath, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearGroupFileInstallPath, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getUnevaluatedGroupFileInstallPath() : std::optional<std::string>(), "Group File Install Path", gameConfigurationPanel, gameConfigurationSizer));
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<void>(std::bind(&GameVersion::getUnevaluatedAlternateModFilesInstallPath, m_gameVersion.get()), std::bind(&GameVersion::setAlternateModFilesInstallPath, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearAlternateModFilesInstallPath, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getUnevaluatedAlternateModFilesInstallPath() : std::optional<std::string>(), "Alt Mod Files Install Path", gameConfigurationPanel, gameConfigurationSizer));
	m_settingsPanels.push_back(SettingPanel::createOptionalIntegerSettingPanel<uint16_t>(std::bind(&GameVersion::getMaximumGroupFiles, m_gameVersion.get()), std::bind(&GameVersion::setMaximumGroupFiles, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearMaximumGroupFiles, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getMaximumGroupFiles() : GameVersion::DEFAULT_MAXIMUM_GROUP_FILES, "Max Group Files", gameConfigurationPanel, gameConfigurationSizer));
	m_settingsPanels.push_back(SettingPanel::createOptionalBooleanSettingPanel(std::bind(&GameVersion::getRequiresOriginalGameFiles, m_gameVersion.get()), std::bind(&GameVersion::setRequiresOriginalGameFiles, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearRequiresOriginalGameFiles, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getRequiresOriginalGameFiles() : std::optional<bool>(), "Requires Original Game Files", gameConfigurationPanel, gameConfigurationSizer));
	...
	m_settingsPanels.push_back(SettingPanel::createBooleanSettingPanel(std::bind(&GameVersion::areScriptFilesReadFromGroup, m_gameVersion.get()), std::bind(&GameVersion::setScriptFilesReadFromGroup, m_gameVersion.get(), std::placeholders::_1), defaultGameVersion != nullptr ? defaultGameVersion->areScriptFilesReadFromGroup() : false, "Script Files Read from Group", gameConfigurationPanel, gameConfigurationSizer));
	...
	m_settingsPanels.push_back(SettingPanel::createBooleanSettingPanel(std::bind(&GameVersion::areZipArchiveGroupsSupported, m_gameVersion.get()), std::bind(&GameVersion::setZipArchiveGroupsSupported, m_gameVersion.get(), std::placeholders::_1), defaultGameVersion != nullptr ? defaultGameVersion->areZipArchiveGroupsSupported() : false, "Supports Zip Archive Groups", gameConfigurationPanel, gameConfigurationSizer));
	...
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<bool>(std::bind(&GameVersion::getEpisodeArgumentFlag, m_gameVersion.get()), std::bind(&GameVersion::setEpisodeArgumentFlag, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearEpisodeArgumentFlag, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getEpisodeArgumentFlag() : std::optional<std::string>(), "Episode", argumentsPanel, argumentsSizer, 1));
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<bool>(std::bind(&GameVersion::getLevelArgumentFlag, m_gameVersion.get()), std::bind(&GameVersion::setLevelArgumentFlag, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearLevelArgumentFlag, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getLevelArgumentFlag() : std::optional<std::string>(), "Level", argumentsPanel, argumentsSizer, 1));
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<bool>(std::bind(&GameVersion::getSkillArgumentFlag, m_gameVersion.get()), std::bind(&GameVersion::setSkillArgumentFlag, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearSkillArgumentFlag, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getSkillArgumentFlag() : std::optional<std::string>(), "Skill", argumentsPanel, argumentsSizer, 1));
	m_settingsPanels.push_back(SettingPanel::createOptionalIntegerSettingPanel<uint8_t>(std::bind(&GameVersion::getSkillStartValue, m_gameVersion.get()), std::bind(&GameVersion::setSkillStartValue, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearSkillStartValue, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getSkillStartValue() : GameVersion::DEFAULT_SKILL_START_VALUE, "Skill Start Value", argumentsPanel, argumentsSizer));
	m_settingsPanels.push_back(SettingPanel::createOptionalStringSettingPanel<bool>(std::bind(&GameVersion::getRecordDemoArgumentFlag, m_gameVersion.get()), std::bind(&GameVersion::setRecordDemoArgumentFlag, m_gameVersion.get(), std::placeholders::_1), std::bind(&GameVersion::clearRecordDemoArgumentFlag, m_gameVersion.get()), defaultGameVersion != nullptr ? defaultGameVersion->getRecordDemoArgumentFlag() : std::optional<std::string>(), "Record Demo", argumentsPanel, argumentsSizer, 1));
	...
	gameVersionConfigurationSizer->AddGrowableRow(1, 5);
