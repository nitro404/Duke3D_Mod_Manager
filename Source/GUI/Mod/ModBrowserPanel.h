...
class LaunchedEvent;
class LaunchStatusUpdatedEvent;
...
private:
	...
	void onGameLaunched(LaunchedEvent & launchedEvent);
	void onGameLaunchStatusUpdated(LaunchStatusUpdatedEvent & launchStatusUpdatedEvent);
	void onGameLaunchFailed(LaunchFailedEvent & launchFailedEvent);
