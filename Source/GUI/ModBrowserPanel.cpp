...
ModBrowserPanel::ModBrowserPanel(std::shared_ptr<ModManager> modManager, wxWindow * parent, wxWindowID windowID, const wxPoint & position, const wxSize & size, long style)
	...
	, m_modGameVersionComboBox(nullptr)
	...
	wxBoxSizer * m_modInfoSizer = new wxBoxSizer(wxHORIZONTAL);
	m_modInfoSizer->Add(m_modInfoPanel, 1, wxEXPAND | wxALL, 20);
	m_modInfoBox->SetSizer(m_modInfoSizer);

	wxFlexGridSizer * m_modInfoPanelSizer = new wxFlexGridSizer(2, border, border);
	m_modInfoPanelSizer->AddGrowableCol(0, 0);
	m_modInfoPanelSizer->AddGrowableCol(1, 1);
	m_modInfoPanelSizer->Add(modNameLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_modNameText, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(modTypeLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_modTypeText, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(initialReleaseDateLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_initialReleaseDateText, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_latestReleaseDateLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_latestReleaseDateText, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(supportedGameVersionsLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_supportedGameVersionsText, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_modWebsiteHyperlinkLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_modWebsiteHyperlink, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_notesLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_notesText, 1, wxEXPAND | wxALL);
	m_modInfoPanelSizer->Add(m_teamWebsiteHyperlinkLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_teamWebsiteHyperlink, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_teamEmailHyperlinkLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_teamEmailHyperlink, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_teamLocationLabel, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_teamLocationText, 1, wxEXPAND | wxHORIZONTAL);
	m_modInfoPanelSizer->Add(m_teamMembersLabel, 1, wxEXPAND | wxALL);
	m_modInfoPanelSizer->Add(m_teamMembersText, 1, wxEXPAND | wxALL);
	m_modInfoPanel->SetSizer(m_modInfoPanelSizer);
	...
	gameOptionsSizer->Add(modGameVersionLabel, wxGBPosition(0, 6), wxGBSpan(1, 1), wxEXPAND | wxHORIZONTAL | wxALIGN_CENTER_VERTICAL, border);
	gameOptionsSizer->Add(m_modGameVersionComboBox, wxGBPosition(0, 7), wxGBSpan(1, 1), wxEXPAND | wxHORIZONTAL | wxALIGN_CENTER_VERTICAL, border);
